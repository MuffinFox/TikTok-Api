...
class TikTokApi:
    ...
    def get_user(self, username, **kwargs) -> dict:
        ...
        static_url = kwargs.get('static_url',
                                "https://www.tiktok.com/api/user/detail/?aid=1988&app_language=en&app_name=tiktok_web&browser_language=en-US&browser_name=Mozilla&browser_online=true&browser_platform=Linux%20x86_64&browser_version=5.0%20%28X11%29&channel=tiktok_web&cookie_enabled=true&device_id=7089341815074047494&device_platform=web_pc&focus_state=true&from_page=user&history_len=5&is_fullscreen=false&is_page_visible=true&language=en&os=linux&priority_region=&referer=&region=AT&screen_height=1440&screen_width=2560&secUid=MS4wLjABAAAAKbaCcvTrB39PG9ASRPG4l6LVumCrKSxNyJBchfX40oQ_z9m-uSzEtX6V3I5sDusX&tz_name=Europe%2FPrague&uniqueId=sparkcart2022&verifyFp=verify_l6keiwbq_bg0kZQav_jjhe_4wAy_BfoD_sofxVT2sc7pN&webcast_language=en&msToken=DAxG9fm4lsehpD00WZRlxwpoBjFuMIqFlkRiOuXoP0nIej3bvq3PaR5m6hDn-1SFwNZ8Lp_6eppZT9ullKi0WmC4Prd1yCPaFKH2KVfjjWvY8vy53LvpKnWT3_9FK3I_qKdDiQ==&X-Bogus=DFSzsIVO4iGANGIwSsAJn6wim3Ra&_signature=_02B4Z6wo000015lVYOAAAIDB.aAmySsPMeeZVGRAAIV-b3"
                                )

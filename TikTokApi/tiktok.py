...
class TikTokApi:
    ...
    def get_user(self, username, **kwargs) -> dict:
        ...
        static_url = kwargs.get('static_url',
                                "https://www.tiktok.com/api/user/detail/?aid=1988&app_language=en&app_name=tiktok_web&browser_language=en-US&browser_name=Mozilla&browser_online=true&browser_platform=Linux%20x86_64&browser_version=5.0%20%28X11%29&channel=tiktok_web&cookie_enabled=true&device_id=7089341815074047494&device_platform=web_pc&focus_state=true&from_page=user&history_len=4&is_fullscreen=false&is_page_visible=true&language=en&os=linux&priority_region=&referer=&region=AT&screen_height=1440&screen_width=2560&secUid=MS4wLjABAAAAd04PpJrQJrRv5QpeLCz-tj41zTwuemXz6WBpyycnVNGeYqJjlOzJ5fpV9QWK5h4B&tz_name=Europe%2FPrague&uniqueId=rihanna&verifyFp=verify_l6keiwbq_bg0kZQav_jjhe_4wAy_BfoD_sofxVT2sc7pN&webcast_language=en&msToken=cF_Cv5xEng2EeeS9dOgaRQ4R07MFLbt7IOwLB3XLTUXIxsDA3GxmGFgRC4wRGgi9YFQOyxmvkrr_WFQsmY8m_TD5_hP1XFMKLa-B0t4Upo_Jkx-WlpUQGG9BjbZRgZt2z1ivAIzcMUKeVgo=&X-Bogus=DFSzsIVONYJANGIwSspDM6wim35e&_signature=_02B4Z6wo00001b0hBzwAAIDD2dRBFIM11iG9IAOAAAxt33"
                                )

    ...
    def user_batch(self, userID, secUID, count=1000, cursor=0, **kwargs) -> dict:
        ...
        * cursor: The offset of a page
        ...
        static_url = kwargs.get('static_url',
                                'https://m.tiktok.com/api/post/item_list/?aid=1988&app_language=en&app_name=tiktok_web&browser_language=en-US&browser_name=Mozilla&browser_online=true&browser_platform=Linux%20x86_64&browser_version=5.0%20%28X11%29&channel=tiktok_web&cookie_enabled=true&device_id=7089341815074047494&device_platform=web_pc&focus_state=true&from_page=user&history_len=3&is_fullscreen=false&is_page_visible=true&os=linux&priority_region=&referer=&region=AT&screen_height=1440&screen_width=2560&tz_name=Europe%2FPrague&verifyFp=verify_l4n85vqe_EFbbAef0_uv6x_47lj_AQjy_mjGkDu636A1G&webcast_language=en&msToken=LCvtsf-U3bRDmZt1p-3pv75d8xEIP9AAmoFFI5rmioz449yPvoKgaM3ZI58a5JF1ICcOAG8x8YLDTkY8rytwlJDg3FdWQDmD0YfVbCs7yHdY71kRiYdz2lzg0L1t5kT3kwbkpOj7rgb6a1o=&X-Bogus=DFSzsIVYvg0ANx/lSIbAG7Lz-WSd&_signature=_02B4Z6wo00001Ch1G3gAAIDD-rMOt3lTukAodB.AAGjHb7')
        response = []

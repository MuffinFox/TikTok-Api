...
class TikTokApi:
    ...
    def get_user(self, username, **kwargs) -> dict:
        ...
        static_url = kwargs.get('static_url',
                                "https://www.tiktok.com/api/user/detail/?aid=1988&app_language=en&app_name=tiktok_web&browser_language=en-US&browser_name=Mozilla&browser_online=true&browser_platform=Linux%20x86_64&browser_version=5.0%20%28X11%29&channel=tiktok_web&cookie_enabled=true&device_id=7089341815074047494&device_platform=web_pc&focus_state=true&from_page=user&history_len=5&is_fullscreen=false&is_page_visible=true&language=en&os=linux&priority_region=&referer=&region=AT&root_referer=https%3A%2F%2Fwww.tiktok.com%2F404%3FfromUrl%3D%2Fnjva18&screen_height=1080&screen_width=1920&secUid=MS4wLjABAAAAichJAsLOcsZBvRZbGPk4v6Yl6C1vUStXtYBEQl-aaIjIPYpMcqS5SsLGmTECFCPu&tz_name=Europe%2FPrague&uniqueId=northjure&verifyFp=verify_l6keiwbq_bg0kZQav_jjhe_4wAy_BfoD_sofxVT2sc7pN&webcast_language=en&msToken=zCcxnyBeKGoHyjYAFyNLCyViyD47sdoQ5N9kcAhuNKKE31gqR3Nkcthfs5JBNLgthhhtcnuJ5SvyAQkBMarNxI0pqcEME5JFq8nP5DJkW39ryWhAViVmkh9KltSTQbrDuCOAAaFZKxtjcTA=&X-Bogus=DFSzsIVOxgtANnYmSBU48gwim35s&_signature=_02B4Z6wo00001NR92XQAAIDCsIifXet7hQzUfN3AAFYi7a"
                                )

...
class TikTokApi:
    ...
    def get_user(self, username, **kwargs) -> dict:
        ...
        static_url = kwargs.get('static_url',
                "https://www.tiktok.com/api/user/detail/?aid=1988&app_language=en&app_name=tiktok_web&browser_language=en-US&browser_name=Mozilla&browser_online=true&browser_platform=Linux%20x86_64&browser_version=5.0%20%28X11%29&channel=tiktok_web&cookie_enabled=true&device_id=7089341815074047494&device_platform=web_pc&focus_state=true&from_page=user&history_len=3&is_fullscreen=false&is_page_visible=true&language=en&os=linux&priority_region=&referer=&region=AT&screen_height=1440&screen_width=2560&secUid=MS4wLjABAAAApMf98czhwD8vrK49L5FCjNj2c4UhpEJcQ5jhS3lp5SugLoDXXc9St5ikxg7RUbwR&tz_name=Europe%2FPrague&uniqueId=andcarli&verifyFp=verify_l6keiwbq_bg0kZQav_jjhe_4wAy_BfoD_sofxVT2sc7pN&webcast_language=en&msToken=7aHOVMa14RCxWOTXzARKWYouigGw3ifHWizginm39j2jpVMI38P0ERfx7ObyitZwXqMmoXoNXLO2ubwVvPCF7ElpFq2UjGuvM6dRPcYny_7z4rnSspGP63ZTHQxS5H9q-NIK3Q==&X-Bogus=DFSzsIVOG3vANnYmSBz0wgwim35S&_signature=_02B4Z6wo000011P-xbAAAIDBNwuDmZdufXdT.8EAALf7ae"
                                )
